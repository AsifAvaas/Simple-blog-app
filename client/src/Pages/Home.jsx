...
function Home() {
  ...
  const fetchBlogs = async () => {
    try {
      ...
      if (response.data.success) { // Fixed condition
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      {/* Create Blog Button */}
      <button onClick={() => (window.location.href = "/blog")} className="bg-blue-500 text-white px-4 py-2 rounded">
        Create Blog
      </button>
      ...
      <div className="mt-4">
        ...
        />
        <button onClick={handleSearch} className="bg-green-500 text-white px-4 py-2 rounded ml-2">
          Search
        </button>
      </div>
